  ...
  <div class="min-h-screen">
    ...
    <header
      ...
      <nav
        ...
        <div class="flex w-full items-center justify-between gap-x-4 md:gap-x-10">
          <NuxtLink to="/" aria-label="Tix Now">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="10 10 320 80" width="180" height="60">
              ...
              <!-- Symbol: Ticket Icon -->
              <path d="M45,45 L55,35 L75,35 L85,45 L75,55 L55,55 L45,45 Z"
                    fill="white"/>

              <!-- Text: TIX NOW -->
              <text x="100" y="52" font-family="'Gloria Hallelujah', cursive" font-size="30" fill="#FF5733"
                    font-weight="bold">
                TIX NOW
              </text>

              <!-- Tagline: Pembelian Tiket Online -->
        ...
        <div id="hs-header-classic"
          ...
          <div
            ...
            <div class="py-2 md:py-0 flex flex-col md:flex-row md:items-center md:justify-end gap-0.5 md:gap-1">
              <NuxtLink active-class="text-orange-600"
                        class="p-2 flex items-center text-sm focus:outline-none focus:text-orange-600"
              ...
              <div
                ...
                <div class="hs-dropdown [--placement:bottom-right] relative inline-flex ml-2">
                  ...
                  <div
                    ...
                    <div v-if="isLogged" class="py-3 px-5 bg-gray-100 rounded-t-lg">
                      <p class="text-sm text-gray-500">Masuk sebagai</p>
                      <p class="text-sm font-medium text-gray-800">{{ user?.full_name }}</p>
                    </div>
                    <div v-if="isLogged && user && user?.role === 'ADMIN' " class="p-1.5 space-y-0.5">
                      <NuxtLink
                    ...
                    <div v-if="isLogged && user && user?.role === 'USER' " class="p-1.5 space-y-0.5">
                      <NuxtLink
                          class="cursor-pointer flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:outline-none focus:bg-gray-100">
                        <svg xmlns="http://www.w3.org/2000/svg" width="1.2em" height="1.2em" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-history"><path d="M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"/><path d="M3 3v5h5"/><path d="M12 7v5l4 2"/></svg>
                        Transaksi
                      </NuxtLink>
                    </div>
                    <div v-if="isLogged" class="p-1.5 space-y-0.5">
                      <NuxtLink
                          class="cursor-pointer flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:outline-none focus:bg-gray-100"
                          @click="handleLogout">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
          ...
          <div class="col-span-1">
            ...
            <div class="mt-3 grid space-y-3">
              ...
              <p><a class="inline-flex gap-x-2 text-gray-400 hover:text-gray-200 focus:outline-none focus:text-gray-200"
                    href="#">Careers</a> <span
                  class="inline-block ms-1 text-xs bg-orange-700 text-white py-1 px-2 rounded-lg">We're hiring</span>
              </p>
              <p><a class="inline-flex gap-x-2 text-gray-400 hover:text-gray-200 focus:outline-none focus:text-gray-200"
                    href="#">Customers</a></p>
            </div>
          ...
          <div class="col-span-2">
            ...
            <form>
              ...
              <p class="mt-3 text-sm text-gray-400">
                New events or tickets. Never spam.
              </p>
            </form>
          </div>
          <!-- End Col -->
